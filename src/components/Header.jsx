        ...
        <>
            <section className="container-none bg-white w-full flex lg:h-40 flex-col p-6 ">
                <div className="flex justify-between items-center mb-4 sm:mb-1 lg:mb-9 ">
                    <img src={menu} alt="" className="w-4 h-4 cursor-pointer sm:block md:block lg:hidden" />

                    <img src={logo} alt="" className=" sm:w-32 h-6 lg:w-60 lg:h-[50px] xl:w-60 xl:h-[50px]"/>
