...
const Banner1 = () => {
    return ( 
        <div className="flex flex-col-reverse flex-wrap justify-center items-center  absolute right-2/4 translate-x-2/4 w-[97%] h-[660px] lg:w-11/12 lg:h-[600px] lg:flex-row">
            <div className="flex flex-col p-3 text-center justify-center gap-4 w-[80%] h-[50%] items-center md:w-2/4 md:h-3/4 md:text-start md:items-start lg:justify-start">
